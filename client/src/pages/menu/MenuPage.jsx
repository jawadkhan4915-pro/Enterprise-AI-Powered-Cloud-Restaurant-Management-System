      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Construct menu items, categorizations, modifiers, pricing, and allergens tags. (Available in Phase 3)
          </p>
        </div>
        ...
        <Card className="flex flex-col items-center justify-center h-96 border-dashed border-2 border-slate-200 dark:border-zinc-800">
          ...
          <h3 className="font-bold text-slate-700 dark:text-zinc-200">Menu Editor Core</h3>
          <p className="text-xs text-slate-400 dark:text-zinc-500 mt-1 max-w-sm text-center">
            Item upload parameters, variant specifications, and pricing modifiers will be structured here in Phase 3.
          </p>
        </Card>
      </div>
    </DashboardLayout>
